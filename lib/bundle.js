...
const gameView = {
  ...
  bindKeyHandlers(){
    key('w', () => this.game.ship.power([0, -2]));
    key('a', () => this.game.ship.power([-2, 0]));
    key('s', () => this.game.ship.power([0, 2]));
    key('d', () => this.game.ship.power([2, 0]));
  }
};
...
const game = {
  ...
  addAsteroids(){
    ...
    for (let i = 0; i < this.NUM_ASTEROIDS; i++){
      mahRoids.push(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__asteroid_js__["a" /* makeAsteroid */])({game: this}));
    }
