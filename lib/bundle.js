...
const gameView = {
  ...
  start(status){
    ...
    this.game.domHandler.displayLives(this.game.numLives);
...
function makeAsteroid(){
  ...
  return Object.assign(Object.create(__WEBPACK_IMPORTED_MODULE_0__moving_object__["a" /* movingObject */]),
  {
    ...
    image,
    size: 45,
    angle: Math.floor(Math.random() * 270) + 45,
    ...
    collideWith(otherObject){
      if (otherObject.type === 'ship'){
        this.game.lostRound(otherObject, otherObject.pos);
