...
document.addEventListener('DOMContentLoaded', function(){
  ...
  window.asteroids = __WEBPACK_IMPORTED_MODULE_0__game_js__["a" /* game */].asteroids;
  window.bullets = __WEBPACK_IMPORTED_MODULE_0__game_js__["a" /* game */].bullets;
});
...
function makeAsteroid(){
  ...
  return Object.assign(Object.create(__WEBPACK_IMPORTED_MODULE_0__moving_object__["a" /* movingObject */]),
  {
    ...
    vel: Math.floor(Math.random() * 2) + 6,
